...
import { PreviewCard, PreviewCardContent, PreviewCardTrigger } from "../ui/preview-card";
  ...
  return (
    ...
    >
      <PreviewCard>
        ...
        <PreviewCardContent data-task-progress-panel="" id={panelId} role="tooltip" className="p-0">
          <ul
